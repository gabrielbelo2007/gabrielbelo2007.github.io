...
1 & 1 & -6 & 11 & -6 \\
\hline
\downarrow & 1 \times 1 - 6 = -5 & 1 \times (-5) + 11 = 6 & 1 \times 6 - 6 = 0 & \\
& 1 & -5 & 6 & 0 \\
\hline
\end{array}
$$
...
2 & 1 & -4 & 8 & -8 \\
\hline
\downarrow & 2 \cdot 1 = 2 & 2 \cdot (-2) = -4 & 2 \cdot 4 = 8 & \\
& 1 & -2 & 4 & 0 \\
\hline
\end{array}
$$
...
<div class="calculo-scroll">
$$
\lim_{x \to 1} \frac{x-1}{\sqrt{x}-1} = \lim_{x \to 1} \frac{x-1}{\sqrt{x}-1} \cdot \frac{\sqrt{x}+1}{\sqrt{x}+1} = \lim_{x \to 1} \frac{(x-1)(\sqrt{x}+1)}{(\sqrt{x})^2 - 1^2}
$$
...
<div class="calculo-scroll">
$$
\lim_{x \to 27} \frac{x-27}{\sqrt[3]{x}-3} = \lim_{x \to 27} \frac{x-27}{\sqrt[3]{x}-3} \cdot \frac{(\sqrt[3]{x})^2 + 3\sqrt[3]{x} + 3^2}{(\sqrt[3]{x})^2 + 3\sqrt[3]{x} + 3^2}
$$

$$
\lim_{x \to 27} \frac{(x-27)(\sqrt[3]{x^2} + 3\sqrt[3]{x} + 9)}{x-27} =
