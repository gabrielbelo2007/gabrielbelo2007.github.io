...
1.  Temos: $$\sqrt{a^2 - x^2}$$
	...
	$$
	\sqrt{a^2 - x^2} \to \sqrt{a^2 - a^2 \sin^2{\theta}} \to \sqrt{a^2(1 - \sin^2{\theta})} 
	$$

	$$
	\to \sqrt{a^2\cos^2{\theta}} = a \cos{\theta}
	$$
...
2. Temos: $$\sqrt{a^2 + x^2}$$
	...
	$$
	\sqrt{a^2 + x^2} \to \sqrt{a^2 a^2 \tan^2{(\theta)}} \to \sqrt{a^2(1 + \tan^2{(\theta)})}
	$$

	$$
	\to \sqrt{a^2 \sec^2{(\theta)}} = a \sec{(\theta)}
	$$
...
3. Temos: $$\sqrt{x^2 - a^2}$$
	...
	$$
	\sqrt{x^2 - a^2} \to \sqrt{a^2 \sec^2{(\theta)} - a^2} \to \sqrt{a^2(\sec^2{(\theta)} - 1)} 
	$$

	$$
	\to \sqrt{a^2 \tan^2{(\theta)}} = a \tan{(\theta)}
	$$