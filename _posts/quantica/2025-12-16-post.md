...
Essa codificação consiste na aplicação de um conjunto de portas quânticas sobre um estado inicial de qubits (geralmente inicializados como 
|0⟩^{⊗ n}) para mapear o vetor de características clássico x em um estado quântico:
