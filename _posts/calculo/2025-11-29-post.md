...
- **Caso 4**: $$Q(x)$$ contém fatores quadráticos irredutíveis repetidos: 
	...
	- Pelo **Teorema das frações parciais**:
		...
		$$
		\int \frac{P(x)}{Q(x)} = \int \frac{A_1x + B_1}{a_1x^2+b_1x + c} + \int \frac{A_2x+B_2}{(a_1x^2+b_1x+c_1)^2}
		$$

		$$
		+ \int \frac{A_rx + B_r}{(a_1x^2 + b_1x + c_1)^r} + \int \frac{A_{m-1}x + B_{m-1}}{a_2x^2 + b_2x + c_2} + \int \frac{A_mx + B_m}{(a_2x^2 + b_2x + c_2)^2}
		$$
