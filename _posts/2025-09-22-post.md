...
subtitle: Probabilidade Condicionada e Teorema de Bayes na IA
date: 2025-09-22
...
$$P(B_i|A) = \frac{P(A|B_i)P(B_i)}{\sum_{j=1}^{k} P(A|B_j)P(B_j)} \text{, } i = 1, 2, ..., k$$
...
- O que o paciente realmente quer saber é a probabilidade de ter a doença (B) dado que o teste deu positivo (A é positivo).
