...
Esse teorema permite calcular o limite de uma função 'espremendo-a' entre duas outras funções, cujos limites já conhecemos e são de mesmo valor. Aproveita-se do fato de que as funções seno e cosseno são limitadas entre 1 e -1, para obter resultados diretos.
