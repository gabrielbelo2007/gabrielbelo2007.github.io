...
> Em muitas funções com indeterminações do tipo 0/0, é comum que a "fuga" dessa indeterminação aconteça por uma simplificação utilizando um desses produtos notáveis, seja expandindo, seja resumindo ou até mesmo completando (comumente chamado de multiplicação pelo conjugado, muito comum em racionalização de denominadores com raízes).
