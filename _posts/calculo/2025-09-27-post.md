...
- A reta normal é uma reta perpenicular à reta tangente, ou seja, o produto da inclinação da reta tangente pela inclinação da reta normal é igual a -1.

$$m_T \cdot m_N = -1 \to m_N = \frac{-1}{m_T}$$ 

- A reta tangente é horizontal, quando a sua inclinação é igual a 0, ou seja, para os valores de $$x$$, no qual a derivada da função do gráfico é 0.

- A reta tangente é paralela a uma reta $$r$$ qualquer, quando a sua inclinação é a mesma da reta $$r$$, ou seja, para quais valores de $$x$$, a derivada da função do gráfico é igual a inclinação a reta $$r$$.
